...
import { Download, Eye, FileText, Filter, Plus, RefreshCw, UserRound } from "lucide-react"
...
export default function ProfessorAdvertenciasPage() {
  ...
  const [signatureType, setSignatureType] = useState<"professor" | "direcao" | "aluno" | "responsavel">("professor")
  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Minhas Advertências</h1>
          <p className="text-muted-foreground">Gerencie as advertências dos seus alunos.</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Minhas Advertências</CardTitle>
            <FileText className="h-4 w-4 text-slate-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">27</div>
            <p className="text-xs text-slate-500">3 novas esta semana</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500">Aguardando assinatura da direção</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500">Em suas turmas</p>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <Badge variant="outline">3 advertências</Badge>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex justify-end mt-2 gap-2">
                        {index === 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => openSignatureDialog("professor", selectedAluno)}
                          >
                            Assinar
                          </Button>
                        )}
